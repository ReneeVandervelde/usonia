 ...
 */
internal abstract class DelegateSerializer<SERIALIZED, DESERIALIZED>(
    ...
    final override fun deserialize(decoder: Decoder): DESERIALIZED = delegate.deserialize(decoder).let(::deserialize)
    final override fun serialize(encoder: Encoder, value: DESERIALIZED) = delegate.serialize(encoder, serialize(value))
